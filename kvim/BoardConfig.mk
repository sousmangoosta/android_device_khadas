...
#BOARD_ODMIMAGE_PARTITION_SIZE := 134217728
#BOARD_PRODUCTIMAGE_PARTITION_SIZE := 134217728
BOARD_SUPER_PARTITION_SIZE := 1946157056
endif

BOARD_SUPER_PARTITION_GROUPS := kvim
BOARD_KVIM_SIZE := 1941962752
BOARD_KVIM_PARTITION_LIST := system vendor product odm

# DTBO partition definitions
BOARD_PREBUILT_DTBOIMAGE := out/target/product/$(PRODUCT_DIR)/$(PRODUCT_DIR)-kernel/dtbo.img
BOARD_DTBOIMG_PARTITION_SIZE := 8388608

BOARD_KERNEL_CMDLINE += androidboot.dtbo_idx=0 androidboot.force_normal_boot=1 \
androidboot.boot_devices=d0074000.emmc
