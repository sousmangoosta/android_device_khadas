...
$(call inherit-product, device/khadas/common/products/atv/atv_base.mk)
#########################################################################
#
#                                               Media extension
#
...
PRODUCT_PROPERTY_OVERRIDES += \
		ro.boot.fstab_suffix=amlogic \
		ro.hardware=amlogic \
		ro.hardware.platform=amlogic

PRODUCT_NAME := kvim_atv
PRODUCT_DEVICE := kvim
...
TARGET_FIRMWARE_DTSI := firmware_dynamic.dtsi
else
...
PRODUCT_COPY_FILES += \
    device/khadas/$(PRODUCT_DIR)/fstab.dynamic:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.amlogic \
    device/khadas/$(PRODUCT_DIR)/fstab.dynamic:$(TARGET_COPY_OUT_RAMDISK)/first_stage_ramdisk/fstab.amlogic \
    device/khadas/$(PRODUCT_DIR)/fstab.dynamic:$(TARGET_COPY_OUT_RECOVERY)/root/first_stage_ramdisk/fstab.amlogic
#PRODUCT_COPY_FILES += \
